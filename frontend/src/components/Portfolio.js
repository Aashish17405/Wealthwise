        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all">
              ...
              <p className="text-2xl font-bold mt-2">
                {formatCurrency(
                  portfolioData.totalInvestment || portfolioData.totalValue || 0
                )}
              </p>
            </div>
              ...
              <div className="flex items-center mt-2">
                <p
                  className={`text-2xl font-bold ${getStatusColor(
                    portfolioData.insights?.totalProfitLoss || 0
                  )}`}
                >
                    ...
                    <div className="flex flex-col">
                      ...
                      <div
                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                          portfolioData.insights.overallStatus === "Positive"
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center">
                          ...
                          <span>
                            Profit: {portfolioData.insights.profitableStocks}
                          </span>
                        </div>
                        <div className="flex items-center">
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-green-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          <div>
                            ...
                            <p>
                              {formatCurrency(
                                portfolioData.insights.bestPerformer.boughtPrice
                              )}
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p
                              className={getStatusColor(
                                portfolioData.insights.bestPerformer.profitLoss
                              )}
                            >
                              {formatCurrency(
                                portfolioData.insights.bestPerformer.profitLoss
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-red-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p
                              className={getStatusColor(
                                portfolioData.insights.worstPerformer.profitLoss
                              )}
                            >
                              {formatCurrency(
                                portfolioData.insights.worstPerformer.profitLoss
                ...
                portfolioData.portfolio.length > 0 ? (
                    ...
                    <tbody>
                      {portfolioData.portfolio.map((stock, index) => (
                        <tr
                          key={stock.symbol}
                          className={`${
                            index !== portfolioData.portfolio.length - 1
                  ...
                  <div className="p-6 text-center">
                    <p className="text-gray-300">
                      Your portfolio is empty. Start investing to see your
                      holdings here.
                    </p>
                  </div>
                )}
                          ...
                          transactionResult.details && (
                            <div className="mt-3 space-y-2 text-sm bg-gray-800/50 p-3 rounded">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {formatCurrency(
                                    transactionResult.details.total
                                  )}
                                </span>
                              </div>
                            </div>
                          ...
                          <div className="mt-4 p-3 bg-indigo-900/30 border border-indigo-700 rounded">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm">
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {formatCurrency(
                                    transactionResult.portfolioValue
                                  )}
                                </p>
                              </div>
                            </div>
